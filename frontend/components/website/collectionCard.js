                ...
                <Link href={'/collection/'+contract_address}>
                    <a className='rounded relative'>
                        <div className='h-1000'>
                            <img className='w-full h-full rounded-2xl object-cover' src={`http://${process.env.DOMAIN_NAME}:9000/` + backgroundImage} />
                        </div>
                        <img className='w-24 h-24 rounded-lg border-8 border-white absolute left-14 top-14 object-cover' src={`http://${process.env.DOMAIN_NAME}:9000/` + profileImage} />
                        <div className='absolute bottom-10 left-10 w-10/12'>
                            ...
                            <Link href={'/profile/'+uniqueName}>
                                <button className='rounded-full bg-gray-300 flex flex-row bg-opacity-30'>
                                    <img src={`http://${process.env.DOMAIN_NAME}:9000/` + userProfileImage} className='w-10 h-10 opacity- rounded-full m-2 ' />
